...
* Currently toolbot is the strongest bot I have, but he is very weak against sniping. Build a sniper bot to force myself to beat this strategy.
...
* Identifying neutrals to cap should be better. Cap when ships expended to capture it is less than the enemy would spend to capture it. Win is because of regeneration. d(target, enemy) * target.regen > target.num_ships. http://72.44.46.68/canvas?game_id=646192
* Identify planets to protect or feed. http://72.44.46.68/canvas?game_id=646165
